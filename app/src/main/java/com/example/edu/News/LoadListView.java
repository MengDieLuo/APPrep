...
public class LoadListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private int headerHeight,footerHeight;//顶部布局文件的高度
    private ProgressBar header_pb,footer_pb;
    ...
    private void initViews(Context context) {
        ...
        footer_pb = footer.findViewById(R.id.footer_pb);
        footer.findViewById(R.id.ll_footer).setVisibility(GONE);
        //初始化时设置footer不可见

        header = inflater.inflate(R.layout.header, null);

        tip = (TextView) header.findViewById(R.id.tipbtn);
        arrow = (ImageView) header.findViewById(R.id.arrow);
        header_pb = (ProgressBar) header.findViewById(R.id.header_pb);
        //测量header的宽和高
        measureView(header);
        //记录下header的高
